...
var getActiveTabIndex = function getActiveTabIndex(props) {
    var cronExpression = props.cronExpression;

    var parsedExpression = (0, _utils.parseCronExpression)(cronExpression);
...
var CronBuilder = (_temp = _class = function (_PureComponent) {
    ...
    _createClass(CronBuilder, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    _reactIf.If,
                    { condition: !!generatedExpression && showResult },
                    _react2.default.createElement(
                        _reactIf.Then,
                        null,
                        _react2.default.createElement(
                            'div',
                            { 'data-result': true },
                            _react2.default.createElement('hr', styleNameFactory('hr')),
                            _react2.default.createElement(PrettyExpression, { expression: generatedExpression }),
                            _react2.default.createElement(
                                'div',
    ...
    this.generateExpression = function () {
        ...
        _this3.setState({
            generatedExpression: (0, _utils.generateCronExpression)(_this3.presetComponent.getExpression())
        }, function () {
            return onChange(_this3.state.generatedExpression);
        });
    };

    this.selectTab = function (activeIndex) {
        return function () {
            _this3.setState({
                activeIndex: activeIndex,
                Component: components[activeIndex]
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react.Children.map(children, function (child) {
                        ...
                        return _react2.default.createElement(
                            _reactIf.If,
                            { condition: child.type.className === activeComponent },
                            _react2.default.createElement(
                                _reactIf.Then,
                                null,
                                _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'select',
                        { onChange: this.setActiveComponent },
                        _react2.default.createElement(
                            'option',
                            { value: _index.DayOfWeek.className },
                            '\u6BCF\u5468'
                        ),
                        _react2.default.createElement(
                            'option',
                            { value: _index.DayOfMonth.className },
                            '\u6BCF\u6708'
                        ),
                        _react2.default.createElement(
                            'option',
                            { value: _index.Month.className },
                            '\u6708\u4EFD'
                        )
                    )
                )
...
var weekDaysOptions = ['星期一', '星期二', '星期三', '星期四', '星期五', '星期六', '星期日'].map(function (day, i) {
    return {
        label: day,
        value: String(i + 1)
    };
...
var monthOptions = ['一月', '二月', '三月', '四月', '五月', '六月', '七月', '八月', '九月', '十月', '十一月', '十二月'].map(function (month, i) {
    return {
        label: month,
        value: String(i + 1)
    };
...
var minutesOptions = (0, _utils.toOptions)((0, _range2.default)(1, 60)).map(function (option) {
